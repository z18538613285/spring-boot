...
public abstract class AbstractLoggingSystem extends LoggingSystem {
	 ...
	 *
	 * @tips 获得约定的配置文件。例如说：LogbackLoggingSystem
	 * 返回的是 "logback-test.groovy"、"logback-test.xml"、 "logback.groovy"、"logback.xml" 。
	 */
	 ...
	 *
	 * @tips 用于 Spring Boot LogLevel 和日志框架的 LogLevel 做映射。
	 */
