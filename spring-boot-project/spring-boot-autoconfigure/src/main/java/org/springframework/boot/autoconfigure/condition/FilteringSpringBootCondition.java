 ...
 * @author Phillip Webb
 *
 * @tips 继承 SpringBootCondition 抽象类，实现 AutoConfigurationImportFilter、BeanFactoryAware、BeanClassLoaderAware 接口，
...
abstract class FilteringSpringBootCondition extends SpringBootCondition
	...
	/**
	 * ClassNameFilter ，是 FilteringSpringBootCondition 的内部类，提供判断类是否存在的功能。
	 */
